    ...
    <div class="p-4 flex-1">
      ...
      <div class="flex justify-center items-center mt-6 md:mt-10">
        <div class="bg-white rounded-2xl p-6 w-full max-w-lg">
          <p class="text-[#163891] text-lg mb-8"> Completa los campos a continuación para agregar un nuevo doctor al sistema.</p>
          ...
          <!-- Botón Guardar -->
          <button class="bg-[#2B3674] text-white font-semibold py-2 px-4 rounded-lg w-full"> Guardar</button>
        </div>
      </div>
    </div>
  </div>
