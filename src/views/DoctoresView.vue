    ...
    <div class="p-4 flex-1">
      ...
      <div class="bg-white p-6 rounded-2xl max-w-4xl mx-auto mt-6 md:mt-10">
        ...
        <div class="flex justify-end mb-5 md:-mt-9">
          <button @click="$router.push('/registrar-doctor')"
        ...
        <!-- Div doctor -->
        <div v-for="(doctor, index) in doctores" :key="index"
          ...
          <div class="flex items-center space-x-4">
            <!-- Botón de editar -->
            <button @click="editarDoctor(doctor)" class="focus:outline-none">
            ...
            <button @click="estadisticasDoctor(doctor)" class="focus:outline-none">
