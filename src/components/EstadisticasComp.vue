  ...
  <div>
    <div class="flex items-center">
      <div class="flex flex-col md:flex-row">
        ...
        <div
          class="bg-white rounded-2xl p-1 h-18 flex items-center space-x-2 mt-4 md:mt-6 md:ml-11 w-[340px] md:w-[272px]">
          ...
          <div class="relative w-full">
            <button @click="toggleOptions"
              ...
              {{ selectedOption }}
              <svg class="ml-2 h-4 w-4 text-[#163891] transition-transform" :class="{ 'rotate-180': isOpen }"
    ...
    <div class="flex flex-col md:flex-row space-x-0 md:space-x-11 mt-6 md:ml-11">
      <div v-for="(value, index) in currentMotivos" :key="index"
        ...
        <div class="flex items-center ml-3 md:ml-0">
          <div class="bg-[#EBF0FD] rounded-full p-3">
            <svg class="w-7 h-7 text-[#163891]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
              height="24" fill="currentColor" viewBox="0 0 24 24">
              <!-- Puedes ajustar los iconos según el tipo -->
              <path v-if="index === 0" fill-rule="evenodd"
              ...
              <path v-if="index === 1" fill-rule="evenodd"
                d="M21.707 21.707a1 1 0 0 1-1.414 0l-3.5-3.5a1 1 0 0 1 1.414-1.414l3.5 3.5a1 1 0 0 1 0 1.414Z"
                clip-rule="evenodd" />
              <path v-else-if="index === 2" fill-rule="evenodd"
                ...
                clip-rule="evenodd" />
              <path v-else-if="index === 3" fill-rule="evenodd"
                d="M9 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4H7Zm8-1a1 1 0 0 1 1-1h1v-1a1 1 0 1 1 2 0v1h1a1 1 0 1 1 0 2h-1v1a1 1 0 1 1-2 0v-1h-1a1 1 0 0 1-1-1Z"
                clip-rule="evenodd" />
              <path v-else-if="index === 4" fill-rule="evenodd"
...
export default {
  ...
  methods: {
    ...
    getStats() {
      ...
      let peticion;
      if (ruta === '/inicio') {
        peticion = `${this.$apiRoute}/estadisticas-generales`;
      } else if (ruta === '/recepcion') {
        peticion = `${this.$apiRoute}/estadisticas-recepcion/${this.$auxiliar.id}`;
      } else if (ruta === '/estadisticas-doctor') {
        peticion = `${this.$apiRoute}/estadisticas-doctor/${this.$auxiliar.id}`;
      }
      ...
      axios
        ...
        .then(response => {
          this.currentMotivos = response.data.casos
        })
        .catch(error => {
